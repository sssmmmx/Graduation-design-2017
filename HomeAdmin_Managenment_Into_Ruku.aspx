<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HomeAdmin_Managenment_Into_Ruku.aspx.cs" Inherits="HomeAdmin" %>
                            ...
                            <asp:Parameter Name="original_Wages" Type="Decimal" />
                                ...
                                <div class="footer">
                                    <div class="legend">
                                        ...
                                        &nbsp; <a href="HomeAdmin_Managenment_Into_Ruku.aspx">将待审核任务添加到审核区域，点击此处刷新列表.</a></li>
</div>
                                    <hr/>
                                    <div class="stats">
                                        &nbsp;</div>
